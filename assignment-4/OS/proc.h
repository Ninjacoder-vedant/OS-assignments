...
// Per-process state
struct proc {
    int             is_thread;      // 0 if main proc 1 if spawned thread 
    int             main_tid;       // (pid of main thread  of this addr space)
    void*           ustack;         // virtual addr of the user stack page allocated for this thread 
    int*            joined;         // 0/1 whether someone joined this thread or not 
